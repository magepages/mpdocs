...
You should install [Mageplaza SMTP](https://mageplaza.com/magento-2-smtp/) to avoid your email being sent to the spam box. It is fully compatible with the Cron Schedule extension.
